package Combination.content;

import Combination.world.blocks.defense.*;
import Combination.world.draw.*;
import arc.graphics.*;
import arc.math.*;
import arc.struct.*;
...
import Combination.world.blocks.power.*;
import Combination.world.blocks.distribution.*;

import static Combination.content.CMItems.*;
import static Combination.content.CMLiquids.*;
import static Combination.content.CMStatusEffects.*;
import static Combination.content.CMUnits.*;
    ...
    public static void load(){
        ...
        anado = new ItemTurret("anado"){{
            ...
            ammo(
                ...
                lead, new BasicBulletType(2f, 7){{
                    ...
                    frontColor = CMPal.leadFront;
                    backColor = CMPal.leadBack;
        ...
        piercer = new PowerTurret("piercer"){{
            ...
            shootEffect = new ParticleEffect(){{
                ...
                strokeFrom = 2;
                strokeTo = 1;
                colorFrom = CMPal.greenLaserBack;
            ...
            shootType = new BasicBulletType(8f, 210){{
                chargeEffect = new MultiEffect(
                    new ParticleEffect() {{
                        ...
                        colorFrom = CMPal.greenLaserBack;
                        colorTo = CMPal.greenLaserBack;
                    }},
                    new WaveEffect() {{
                        sizeFrom = 0;
                        sizeTo = 8;
                        lifetime = shoot.firstShotDelay;
                        colorFrom = CMPal.greenLaserFront;
                        colorTo = CMPal.greenLaserBack;
                    }}
                );
                pierceBuilding = true;
                ...
                frontColor = CMPal.greenLaserFront;
                backColor = CMPal.greenLaserBack;
                hitColor = CMPal.greenLaserBack;
                lightColor = CMPal.greenLaserBack;
                trailColor = CMPal.greenLaserBack;
                trailWidth = 6;
                trailLength = 20;
        ...
        enforcer = new PowerTurret("enforcer"){{
            ...
            shootType = new EmpBulletType(){{
                ...
                frontColor = CMPal.greenLaserFront;
                backColor = CMPal.limeLaserBack;
                lightColor = CMPal.limeLaserBack;
                hitColor = CMPal.limeLaserBack;
                hitEffect = despawnEffect = CMFx.cavernFx;
                chargeEffect = new MultiEffect(
                    new WaveEffect(){{
                        sizeFrom = 0;
                        sizeTo = 30;
        ...
        cavern = new PowerTurret("cavern"){{
            ...
            shootType = new EmpBulletType(){{
                ...
                lightOpacity = 0.7f;
                frontColor = CMPal.greenLaserFront;
                backColor = lightColor = hitColor = CMPal.limeLaserBack;
                hitEffect = Fx.none;
                despawnEffect = CMFx.cavernFx;
        ...
        hexagon = new ItemTurret("hexagon"){{
            ...
            ammo(
                ...
                stariumAlloy, new ArtilleryBulletType(5f, 60){{
                    ...
                    frontColor = CMPal.stariumAlloyFront;
                    backColor = CMPal.stariumAlloyBack;
        ...
        underglow = new PowerTurret("underglow"){{
            ...
            shootType = new EmpBulletType(){{
                ...
                fragBullet = new EmpBulletType(){{
                    ...
                    status = CMStatusEffects.lockdown;
                    statusDuration = 360;
                    damage = 25;
